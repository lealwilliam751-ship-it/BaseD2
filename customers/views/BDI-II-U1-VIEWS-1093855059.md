...
WHERE order_id = 'ORD20260320-5D34997'; 
```
...
WITH CHECK OPTION en una vista actualizable impide realizar INSERT o UPDATE que hagan que una fila deje de cumplir la condición , garantizando así que todo lo que se modifique a través de la vista siga siendo visible en ella.
